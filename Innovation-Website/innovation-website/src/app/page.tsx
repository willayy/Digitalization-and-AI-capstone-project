    ...
    <div className="page">
      <div className="center">
        ...
        <p className="paragraph">
          SKAPA is an AI-driven tool with the purpose of generating photorealistic images in style with IKEAs catalog to reduce the amount
        ...
        <p className="paragraph">
          To ensure images are within IKEAs style, SKAPA is connected to a database with large amounts of
          sample date already existing from IKEAs current website. When generating an image, the idea is that the user can rate, accept and reject an image 
