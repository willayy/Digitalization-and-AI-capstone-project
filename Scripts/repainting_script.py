...
def enable_memory_save_mode(pipeline: StableDiffusionXLImg2ImgPipeline) -> None:
...
MODEL_NAME: str = "stabilityai/stable-diffusion-xl-refiner-1.0" #"runwayml/stable-diffusion-inpainting" 
